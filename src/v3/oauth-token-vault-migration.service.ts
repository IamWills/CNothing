import { pool } from "../db";
import { unpackEncrypted } from "../v2/oauth.repository";
import type { OAuthConnectionRecord, OAuthProviderRecord } from "../v2/v2.5.entity";
import {
  exchangeConnectionTokensInVault,
  storeProviderClientSecretInVault,
} from "./oauth-vault-bridge.service";
