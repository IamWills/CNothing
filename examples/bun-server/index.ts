...
const privateKeyPem = process.env.CNOTHING_CLIENT_PRIVATE_KEY_PEM ?? generated.privateKeyPem;
const publicKeyPem = process.env.CNOTHING_CLIENT_PUBLIC_KEY_PEM ?? generated.publicKeyPem;
...
const client = new CNothingClient({
  ...
  clientLabel: process.env.CNOTHING_CLIENT_LABEL ?? "bun-example",
  privacyKey,
});
...
const namespace = process.env.CNOTHING_NAMESPACE ?? "examples.bun.production";
